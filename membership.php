                            ...
                            if (isset($_SESSION['username'])) {
                                ...
                                <li class='dropdown'>
                                    ...
                                    <div class = 'dropdown-content'>
                                        <select class='select_membership' data-placeholder='Select Membership'>
                                            <option></option>
    ...
    <div class="login-page">
        <div class="container">
            <form action="" method="POST" class="login-email">
                ...
                <div class="input-group">
                    <button class="silver_mem">Silver</button>
                    <button class="gold_mem">Gold</button>
                    <button class="platinum_mem">Platinum</button>
                    <div class="input-group">
